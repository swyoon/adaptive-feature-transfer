...
def main(seed, dataset, ckpt, aft_module, aft_score,num_target_images, save_dir, class_names, use_downstream, batch_size, args):
    lmda = args.lmda
    ...
    FKD_ARGS = {
        ...
        "resampling_t_end": 40,
        "time_steps": 50, # set as same as resampling_t_end
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size for DiT sampling')
    ...
    print("generating data with dit fk steering...")
    ...
    main(seed, dataset, ckpt, aft_module, aft_score, num_target_images, save_dir, class_names, use_downstream, args)