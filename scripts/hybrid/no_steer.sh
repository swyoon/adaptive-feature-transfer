...
if [ "$use_downstream" = "True" ]; then
    image_dir="./artifacts/251027/hybrid/edm_aft_no_hybrid_steering_with_downstream/flowers-${seed}"
else
    image_dir="./artifacts/251027/hybrid/edm_aft_no_hybrid_steering/flowers-${seed}"
fi
...
# auto
if [ "$use_downstream" = "True" ]; then
    steer_method=edm_aft_no_hybrid_steering_with_downstream
else
    steer_method=edm_aft_no_hybrid_steering
fi
