...
def main(seed, ckpt, num_target_images, save_dir, class_names, batch_size):
    DEVICE = 'cuda'
    config = f"""
        ckpt_path: {ckpt}
...
if __name__ == "__main__":
    ...
    print("generating data with dit...")
    ...
    main(seed, ckpt, num_target_images, save_dir, class_names, batch_size)